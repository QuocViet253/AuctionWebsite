...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/public/css/elegant-icons.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/public/css/themify-icons.css">
</head>
<body>
<!-- Page Preloder -->
    <div id="preloder">
    ...
    <script src="${pageContext.request.contextPath}/public/js/jquery.dd.min.js"></script>
