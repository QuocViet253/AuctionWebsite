...
<t:manager>
    ...
    <jsp:body>
        ...
        <div class="tableFixHistory" id="tableFixHistory1" style="cursor: pointer ; height: 50%">
        ...
        <div class="tableFixHistory d-none" id="tableFixHistory2" style="cursor: pointer ; height: 50%">
            <table class="table  table-hover " style="width: 75%; height: 5px; margin: auto">
                <thead>
                <tr>
                    <th scope="col" style="background-color: black"><p style="color: white">ID</p></th>
