                    ...
                    <div class="row">
                        <div class="col-md-3" >
                            <div class="product-top">
                                <a href="product.html"><img src="https://cdn.tgdd.vn/Products/Images/42/213031/iphone-12-xanh-duong-new-2-600x600.jpg"></a>
                                <div class="overlay-right">
                                    <button type="button" class="btn btn-secondary" title="Detail">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                    <button type="button" class="btn btn-secondary" title="Add to WatchList">
                        ...
                        <div class="col-md-3">
                            <div class="product-top">
                                ...
                                <div class="overlay-right">
                                    <button type="button" class="btn btn-secondary" title="Detail">
                                        <i class="fa fa-eye" style="border-radius: 50%;" ></i>
                                    </button>
                                    <button type="button" class="btn btn-secondary" title="Add to WatchList">
